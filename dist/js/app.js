(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-page__slider")) new core(".slider-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            navigation: {
                ...
                nextEl: ".slider-page__nex"
            },
            on: {}
        });
        if (document.querySelector(".photo__slider")) new core(".photo__slider", {
